...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set b [ create_bd_port -dir I -from 6 -to 0 b ]
  set clk_b [ create_bd_port -dir O -type clk clk_b ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {25000000} \
 ] $clk_b
  set clk_g [ create_bd_port -dir O -type clk clk_g ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {25000000} \
 ] $clk_g
  set clk_r [ create_bd_port -dir O -type clk clk_r ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {25000000} \
 ] $clk_r
  set g [ create_bd_port -dir I -from 6 -to 0 g ]
  ...
  set_property -dict [ list \
   CONFIG.TRIG0_ASSERT {Active_Low} \
  ...
  # Create instance: vga_sampler_0, and set properties
  set vga_sampler_0 [ create_bd_cell -type ip -vlnv user.org:user:vga_sampler:1.0 vga_sampler_0 ]
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_dma_1/M_AXI_S2MM] [get_bd_intf_pins axi_interconnect_3/S00_AXI]
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_pins axi_dma_1/M_AXI_SG] [get_bd_intf_pins axi_interconnect_2/S01_AXI]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_SG [get_bd_intf_pins axi_dma_0/M_AXI_SG] [get_bd_intf_pins axi_interconnect_2/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_dma_2_M_AXI_MM2S [get_bd_intf_pins axi_dma_2/M_AXI_MM2S] [get_bd_intf_pins axi_interconnect_4/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_dma_2/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_0/M03_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_interconnect_0_M03_AXI] [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins ila_1/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_4_M00_AXI [get_bd_intf_pins axi_interconnect_4/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP3]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_1_M_AXIS [get_bd_intf_pins axis_data_fifo_1/M_AXIS] [get_bd_intf_pins vga_sampler_0/STIMING_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_2_M_AXIS [get_bd_intf_pins axis_data_fifo_2/M_AXIS] [get_bd_intf_pins rgb_gen_1/S00_AXIS]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]
  connect_bd_intf_net -intf_net vga_sampler_0_MPIXEL_AXIS [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins vga_sampler_0/MPIXEL_AXIS]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins clk_wiz_0/resetn] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  ...
  connect_bd_net -net vga_sampler_0_counter [get_bd_pins ila_0/probe2] [get_bd_pins vga_sampler_0/counter]
  connect_bd_net -net vga_sampler_0_line_counter [get_bd_pins ila_0/probe3] [get_bd_pins vga_sampler_0/line_counter]
  connect_bd_net -net vsync_0_1 [get_bd_ports vsync] [get_bd_pins ila_0/probe0] [get_bd_pins vga_sampler_0/vsync]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins vga_sampler_0/red] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins vga_sampler_0/green] [get_bd_pins xlconcat_1/dout]
  connect_bd_net -net xlconcat_2_dout [get_bd_pins vga_sampler_0/blue] [get_bd_pins xlconcat_2/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_timer_0/freeze] [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconcat_1/In0] [get_bd_pins xlconcat_2/In0] [get_bd_pins xlconstant_0/dout]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_1/Data_SG] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_0_HP2_DDR_LOWOCM
